...
public class Board {
	...
	private Cell[] cells;
	/**
	 * The initial image of the board
	 */
	 ...
	 * Compares current state to the original image.
	 *
	 * @return <code>true</code> if the board is completed, <code>false</code>
	 *         otherwise.
	 */
	public boolean isFinished() {
		Board originalBoard = new Board(originalImage, width, dimension);
		if(originalBoard.toString().equals(this.toString())) return true;
		return false;
	}
